...
#______________PLOT MULTIPLE RANDOM WALKS_____________________#
...
#_____________ADDING "CLUMSINESS" TO THE SCRIPT_____________________#
...
plt.plot(np_aw_t)
plt.show()
#______________________PLOT HISTOGRAM FOR OUTCOMES AT 500 ITERATIONS__________________________#
# numpy and matplotlib imported, seed set
